...
public class MultiPointController implements IController {
	...
	public boolean play(Device device, String path) {
		System.out.println("=====play=====11111111==========");
		if (device == null) {
			return false;
		}
		...
		boolean res = playAction.postControlAction();
	...
	public boolean goon(Device device, String pausePosition) {
		...
		boolean res = playAction.postControlAction();
		System.out.println("=====goon play==============="+res);
		return res;
	}
	...
	public boolean stop(Device device) {
		...
		boolean res = stopAction.postControlAction();
	...
	public boolean pause(Device mediaRenderDevice) {
		...
		boolean res = pauseAction.postControlAction();
		System.out.println("====pause================"+res);
		return res;
	}
